...
piper_with_gripper_moveit__action__PoseGoal_Goal__are_equal(const piper_with_gripper_moveit__action__PoseGoal_Goal * lhs, const piper_with_gripper_moveit__action__PoseGoal_Goal * rhs)
{
  ...
  // lock_rp_and_cartesian
  if (lhs->lock_rp_and_cartesian != rhs->lock_rp_and_cartesian) {
    return false;
  }
  // eef_step
  if (lhs->eef_step != rhs->eef_step) {
    return false;
  }
  // jump_threshold
  ...
  piper_with_gripper_moveit__action__PoseGoal_Goal * output)
{
  ...
  // lock_rp_and_cartesian
  output->lock_rp_and_cartesian = input->lock_rp_and_cartesian;
  // eef_step
  output->eef_step = input->eef_step;
  // jump_threshold
