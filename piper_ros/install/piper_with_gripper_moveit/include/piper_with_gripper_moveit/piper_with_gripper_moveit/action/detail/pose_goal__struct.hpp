...
struct PoseGoal_Goal_
{
  ...
  : target_pose(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->col = 0.0;
      this->col2 = 0.0;
      this->lock_rp_and_cartesian = false;
      this->eef_step = 0.0;
  ...
  using _col2_type =
    double;
  _col2_type col2;
  using _lock_rp_and_cartesian_type =
    bool;
  _lock_rp_and_cartesian_type lock_rp_and_cartesian;
  using _eef_step_type =
    double;
  _eef_step_type eef_step;
  ...
  Type & set__lock_rp_and_cartesian(
    const bool & _arg)
  {
    this->lock_rp_and_cartesian = _arg;
    return *this;
  }
  Type & set__eef_step(
    const double & _arg)
  ...
  bool operator==(const PoseGoal_Goal_ & other) const
  {
    ...
    if (this->lock_rp_and_cartesian != other.lock_rp_and_cartesian) {
      return false;
    }
    if (this->eef_step != other.eef_step) {
      return false;
    }
