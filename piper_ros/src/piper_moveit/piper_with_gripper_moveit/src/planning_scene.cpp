...
int main(int argc, char** argv)
{
  ...
  // 바구니 - 바닥
  addBox(psi, "basket_bottom", {0.34, 0.2, 0.02}, makePose(0.0, 0.0+basket_y, 0.01));
  // 바구니 - 앞/뒤 벽
  addBox(psi, "basket_wall_front", {0.34, 0.004, 0.22}, makePose(0.0, 0.09+basket_y, 0.1));
  addBox(psi, "basket_wall_back", {0.34, 0.004, 0.22}, makePose(0.0, -0.09+basket_y, 0.1));
  // 바구니 - 좌/우 벽
  addBox(psi, "basket_wall_left", {0.004, 0.2, 0.22}, makePose(0.14, 0.0+basket_y, 0.1));
  addBox(psi, "basket_wall_right", {0.004, 0.2, 0.22}, makePose(-0.22, 0.0+basket_y, 0.1));
