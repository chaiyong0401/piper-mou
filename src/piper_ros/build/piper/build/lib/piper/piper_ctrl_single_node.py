...
class PiperRosNode(Node):
    ...
    def __init__(self) -> None:
        ...
        # Joint ctrl
        self.joint_ctrl = JointState()
        self.joint_ctrl.name = ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', 'joint7', 'joint8']
    ...
    def PublishArmJointAndGripper(self):
        ...
        joint_7: float = self.piper.GetArmGripperMsgs().gripper_state.grippers_angle / 1000000 /2
        joint_8: float = self.piper.GetArmGripperMsgs().gripper_state.grippers_angle / 1000000 /2
        ...
        effort_7:float = self.piper.GetArmGripperMsgs().gripper_state.grippers_effort/1000/2
        effort_8:float = self.piper.GetArmGripperMsgs().gripper_state.grippers_effort/1000/2
    ...
    def PublishArmCtrlAndGripper(self):
        ...
        joint_7: float = self.piper.GetArmGripperCtrl().gripper_ctrl.grippers_angle/1000000/2
        joint_8: float = self.piper.GetArmGripperCtrl().gripper_ctrl.grippers_angle/1000000/2
        self.joint_ctrl.position = [joint_0, joint_1, joint_2, joint_3, joint_4, joint_5, joint_7, joint_8]  # Example values
