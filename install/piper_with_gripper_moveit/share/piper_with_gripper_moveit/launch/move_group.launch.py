...
def generate_move_group_launch_me(moveit_config):
     ...
     pliz_yaml = load_yaml('piper_with_gripper_moveit', 'config/pilz_industrial_motion_planner_planning.yaml')
     ompl_yaml = load_yaml('piper_with_gripper_moveit', 'config/ompl_plainning.yaml')
     ki_yaml = load_yaml('piper_with_gripper_moveit', 'config/kinematics.yaml')
